...
public class NumberOfDPCHDaoImpl implements NumberOfDPCHDAO{
	...
	@Override
	public Integer pateintCaseSheetCount() throws SQLException {
		Connection connection=null;
		try {
			Context envContext = (Context) new InitialContext().lookup("java:comp/env");		
			DataSource dataSource = (DataSource) envContext.lookup("jdbc/hmsDB");
			connection= dataSource.getConnection();
			Statement statement= connection.createStatement();
			ResultSet resultSet=statement.executeQuery(QueryMapper.COUNT_OF_PATIENT_CASE_SHEETS);
