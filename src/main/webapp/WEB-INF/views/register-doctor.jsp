	...
	<form action="DoctorRegistrationServlet" method="post">
	    <div class="form-group">
			<label>user name</label> <input type="text"
				class="form-control" readonly="readonly" name="userName" value="${user.userName}" placeholder="user name">
		</div> 
		 <div class="form-group">
			<label>password</label> <input type="password"
				class="form-control" readonly="readonly" name="password" value="${user.password}" placeholder="user name">
		</div> 
		<div class="form-group">
			<label>Enter full name</label> <input type="text"
				class="form-control" name="doctorName" placeholder="Enter full name">
		</div>
		<div class="form-group">
